"""
EC operations tester, to test the functions that are in hp5.py file

Author: Paavo Peltopihko
Studentnumber: 194500
"""

from hp5 import addEC, doublEC
...
def testAddEC(testData):
    ...
    print("\nTesting addition in Elliptic curve:")
    testNumber = 1
    faulty = 0
